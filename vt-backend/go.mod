...
require (
	github.com/joakimcarlsson/ai/agent v0.3.0
	github.com/joakimcarlsson/ai/llm/deepseek v0.2.2
...
require (
	...
	github.com/joakimcarlsson/ai/llm v0.3.0 // indirect
	github.com/joakimcarlsson/ai/memory v0.2.1 // indirect
